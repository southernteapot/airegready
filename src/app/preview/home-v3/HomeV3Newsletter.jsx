...
export default function HomeV3Newsletter() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3" noValidate>
      <div className="flex flex-col gap-3 sm:flex-row">
        <label htmlFor="home-v3-newsletter-email" className="sr-only">
          Email address
        </label>
        <input
          id="home-v3-newsletter-email"
          type="email"
          name="email"
          ...
          aria-describedby={message ? 'home-v3-newsletter-message' : undefined}
