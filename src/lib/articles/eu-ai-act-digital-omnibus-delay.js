export const euAiActDigitalOmnibusDelay = {
  ...
  sections: [
    ...
    {
      title: 'What the Digital Omnibus Is',
      content:
    ...
    {
      title: 'The Proposed New Deadlines',
      content:
    ...
    {
      title: 'Why a Delay Was Even on the Table',
      content:
    ...
    {
      title: 'Where the Legislative Process Actually Stands',
      content:
    ...
    {
      title: 'What Is NOT Being Delayed',
      content:
    ...
    {
      title: 'Penalties and Extraterritorial Reach Are Unchanged',
      content:
    ...
    {
      title: 'The Right Posture: "August Is Real, December 2027 Is Likely"',
      content:
  ...
  takeaways: [
    'The European Commission\u2019s Digital Omnibus (Nov 2025) proposes delaying most EU AI Act high-risk obligations by up to 16 months, conditional on harmonized standards being ready.',
    'Parliament\u2019s IMCO and LIBE committees backed new dates of December 2, 2027 (stand-alone high-risk) and August 2, 2028 (embedded in products) by a 101\u20139 vote on March 18, 2026.',
    'The Council of the EU has its own negotiating mandate with different dates. Trilogue negotiations are ongoing; final adoption is targeted before August 2026.',
    'Until trilogue concludes, August 2, 2026 remains the legally binding deadline. Treat the delay as likely but not certain.',
    'Prohibited practices (Feb 2025), GPAI obligations (Aug 2025), AI literacy, and the AI Office are NOT being delayed and remain in force with full penalties.',
    'Watermarking for AI-generated content is proposed to apply from November 2, 2026 \u2014 potentially the next hard deadline regardless of what happens with high-risk.',
    'Right posture: continue building the Annex III compliance program on a late-2026 / early-2027 schedule. Do not pause inventory, literacy training, or governance work.',
  ],

  sources: [
    {
      title: 'European Commission \u2014 Digital Omnibus proposal overview',
      url: 'https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai',
    },
    {
      title: 'Timelex \u2014 Commission proposes one-year delay for high-risk AI obligations',
      url: 'https://www.timelex.eu/en/blog/european-commission-proposes-one-year-delay-high-risk-ai-obligations-and-softens-ai-literacy-0',
    },
    {
      title: 'CIO \u2014 European Parliament votes to delay EU AI Act implementation',
      url: 'https://www.cio.com/article/4150989/european-parliament-delays-implementation-of-parts-of-the-eu-ai-act.html',
    },
    {
      title: 'TechPolicy.Press \u2014 EU\u2019s AI Act Delays Let High-Risk Systems Dodge Oversight',
    ...
    {
      title: 'K&L Gates \u2014 EU and Luxembourg Update on the European Harmonised Rules on AI',
