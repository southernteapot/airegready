export const federalPolicy = {
  ...
  sections: [
    ...
    {
      id: 'current-state',
      title: 'Where Federal AI Policy Stands (June 2026)',
      content:
        'As of June 2026, the federal AI policy landscape has shifted from passive deregulation toward active pressure on state-level AI regulation. The December 2025 executive order on national AI policy, the January 2025 revocation of EO 14110, and the April 2025 OMB memos (M-25-21 and M-25-22) together point to a two-part federal strategy: deregulation and faster federal AI adoption, paired with legal and political pressure against state AI laws the administration views as burdensome.\n\n**What is currently in effect:**\n\nExisting statutory authority remains the primary federal enforcement mechanism for AI. The FTC, FDA, SEC, EEOC, CFPB, and other agencies can still apply their existing laws — the FTC Act, Title VII, ECOA, FCRA, consumer-protection statutes, and sector-specific rules — to AI systems. This authority was never dependent on executive orders and persists regardless of administration. NIST also continues its standards work, including the AI RMF, Generative AI Profile, Cyber AI Profile work, and CAISI activity.\n\n**What has changed:**\n\nThe December 2025 EO created active federal mechanisms to challenge state AI laws. The DOJ AI Litigation Task Force became operational in January 2026 and the Justice Department moved to intervene in xAI\'s lawsuit challenging Colorado\'s original SB 24-205 on April 24, 2026. Colorado then replaced that original law with SB 26-189 on May 14, 2026, before the old June 30 effective date. The Commerce Department assessment of conflicting state laws, FCC proceeding on federal AI reporting, BEAD funding conditions, and March 2026 White House legislative blueprint all continue to create pressure for a more uniform federal approach.\n\n**What this means for organizations:**\n\nOrganizations face real uncertainty, but not a vacuum. The federal government is working to limit state AI patchwork regulation, yet it has not established a comprehensive federal AI statute. State laws remain relevant unless they are repealed, replaced, enjoined, or preempted by Congress. Colorado shows the practical effect: federal pressure did not end state AI regulation, but it helped push the state from a broad high-risk AI law to a narrower ADMT law. The safest approach is to maintain portable governance artifacts — AI inventories, vendor documentation, notices, testing records, human-review procedures, and incident-response processes — while monitoring federal preemption developments closely.',
    },
    {
      id: 'practical-steps',
  ...
  timeline: [
    ...
    },
    {
      date: 'January 9, 2026',
      event:
        'AG Pam Bondi establishes the DOJ AI Litigation Task Force. DOJ later intervenes in xAI\'s lawsuit challenging Colorado SB 24-205, marking the first major federal move against a state AI law.',
    },
    {
      date: 'March 20, 2026',
      event:
