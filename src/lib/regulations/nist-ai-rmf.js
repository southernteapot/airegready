export const nistAiRmf = {
  ...
  sources: [
    ...
    },
    {
      ...
      url: 'https://www.legis.state.tx.us/tlodocs/89R/billtext/html/HB00149F.HTM',
      description:
        'Texas state legislation that references NIST\'s Generative AI Profile and other recognized AI risk management frameworks in enforcement defenses.',
    },
    {
