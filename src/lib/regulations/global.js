export const globalGovernance = {
  ...
  keyFacts: [
    ...
    { label: 'Binding International Treaty', value: 'Council of Europe Framework Convention on AI \u2014 entered into force November 2025' },
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          term: 'Provincial Developments: Ontario Bill 194',
          description:
    ...
    },
    {
      ...
      items: [
        ...
        {
          term: 'AI Content Labeling Measures (September 2025)',
          description:
        ...
        {
          term: 'Cybersecurity Law (CSL) Amendments (January 2026)',
          description:
        ...
        {
          term: 'National AI Governance Framework (September 2025)',
          description:
      ...
      table: {
        ...
        rows: [
          [
            ...
            'The Senate approved PL 2338/2023 on December 10, 2024 and forwarded it to the Chamber of Deputies on March 17, 2025. A special committee of 33 members was established in April 2025 to analyze the bill. Still requires Chamber approval and presidential signature. Expected to be the first major AI law in Latin America.',
          ],
          [
            '**Japan**',
            'Japan passed the **AI Promotion Act** on May 28, 2025 (took effect June 4, 2025; full effect September 2025), making it the second major APAC economy with comprehensive AI legislation. The law takes an innovation-focused approach built around four core principles and establishes an AI Strategy Headquarters within the Cabinet, chaired by the Prime Minister. Notably, the Act contains no explicit penalties\u2014relying instead on a cooperative and reputational compliance model. Japan also published AI Guidelines for Business in 2024 (updated from 2019 Social Principles of AI) and leveraged its G7 presidency in 2023 to advance the Hiroshima AI Process.',
            'Enacted. AI Promotion Act in full effect as of September 2025. Japan is an active participant in international AI governance discussions and the second APAC jurisdiction (after South Korea) to adopt comprehensive AI legislation.',
          ],
          [
            '**South Korea**',
            'South Korea\u2019s National Assembly passed the **Framework Act on AI Development and Establishment of a Foundation for Trustworthiness** on December 26, 2024. Promulgated January 21, 2025, the law takes effect January 22, 2026 (one-year transition period). The Act consolidates 19 separate AI bills into a unified framework covering high-impact AI in healthcare, energy, and public services. It includes mandatory labeling for generative AI content and establishes a national AI governance committee. South Korea became the first APAC jurisdiction to adopt comprehensive AI legislation.',
            'Enacted. Promulgated January 2025 with a one-year transition period. Takes full effect January 22, 2026. South Korea has also been active in developing AI ethics guidelines and sectoral guidance.',
          ],
          [
            '**Singapore**',
  ...
  timeline: [
    ...
    { date: 'December 2024', event: 'South Korea\u2019s National Assembly passes the Framework Act on AI Development and Establishment of a Foundation for Trustworthiness. Brazilian Senate approves AI bill PL 2338/2023.' },
    { date: 'January 2025', event: 'Canadian Parliament prorogued; Bill C-27 (including AIDA) dies on the order paper. South Korea promulgates AI Framework Act (effective January 2026).' },
    { date: 'February 2025', event: 'EU AI Act\u2019s prohibition on unacceptable-risk AI systems takes effect. UK AI Safety Institute renamed to AI Security Institute.' },
    { date: 'March 2025', event: 'Brazilian AI bill PL 2338/2023 forwarded to Chamber of Deputies.' },
    { date: 'May 2025', event: 'Japan passes the AI Promotion Act (took effect June 2025; full effect September 2025)\u2014becoming the second major APAC economy with comprehensive AI legislation.' },
    { date: 'September 2025', event: 'China\u2019s AI Content Labeling Measures take effect alongside mandatory technical standard GB45438-2025. China issues National AI Governance Framework.' },
    { date: 'October 2025', event: 'China\u2019s top legislature passes major Cybersecurity Law amendments incorporating AI provisions (effective January 2026).' },
    { date: 'November 2025', event: 'Council of Europe Framework Convention on AI enters into force\u2014the first binding international AI treaty now in effect, ratified by the UK, France, Norway, and others.' },
    { date: 'January 2026', event: 'China\u2019s Cybersecurity Law amendments take effect, bringing AI into national law. South Korea\u2019s AI Framework Act takes full effect. Global AI regulatory activity continues to accelerate across all major jurisdictions.' },
  ],
  sources: [
    {
