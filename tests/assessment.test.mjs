...
test('provider with no release review or monitoring scores as exposed and gets provider-first recommendation', () => {
  ...
  assert.equal(report.primaryRecommendation?.slug, 'founder-ai-governance-track')
  assert.equal(report.primaryRecommendation?.href, '/catalog/founder-ai-governance-track#request-preview')
