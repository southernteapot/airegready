...
- **When a new law applies** — e.g., a system that was previously out of scope becomes subject to Colorado covered-ADMT rules, another state AI law, or the EU AI Act due to jurisdictional expansion
...
- Keep every completed Impact Assessment (and prior versions) for at least **10 years** after the system is retired, or as required by applicable law (EU AI Act: 10 years after placing on the market; Colorado SB 26-189 / state ADMT rules: verify with counsel; sector rules may require longer).
...
- Colorado covered-ADMT / state AI law template when applicable
